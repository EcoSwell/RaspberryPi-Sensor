...
GMAIL_PASSWORD = 'tzcbnsbevrgflhzu' # change this to match your gmail app-password (see https://bc-robotics.com/tutorials/sending-email-using-python-raspberry-pi/)
