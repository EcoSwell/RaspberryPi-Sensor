...
GMAIL_PASSWORD = 'jeqvbuplhsglerfw' # change this to match your gmail app-password (see https://bc-robotics.com/tutorials/sending-email-using-python-raspberry-pi/)
